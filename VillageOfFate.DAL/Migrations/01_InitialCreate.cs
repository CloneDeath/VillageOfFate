	...
	public class InitialCreate : Migration {
		...
		public override void Up() {
			...
			Create.Table("Villagers")
				  ...
				  .WithColumn("TriggerReaction").AsBoolean().NotNullable().WithDefaultValue(false)
				  .WithColumn("TriggerReactionItemId").AsGuid().Nullable().ForeignKey("Items", "Id")
				  .WithColumn("TriggerReactionVillagerId").AsGuid().Nullable().ForeignKey("Villagers", "Id")
				  .WithColumn("TriggerReactionActiveActionName").AsString(MaxNameLength).Nullable()
